-- Primeiro, verificar o tipo da coluna id na tabela propostas_corretores
-- Se for bigint, usar bigint; se for uuid, usar uuid

-- Criar tabela para dependentes das propostas de corretores (corrigido)
CREATE TABLE IF NOT EXISTS dependentes_propostas_corretores (
    id BIGSERIAL PRIMARY KEY,
    proposta_corretor_id BIGINT NOT NULL REFERENCES propostas_corretores(id) ON DELETE CASCADE,
